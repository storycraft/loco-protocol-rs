...
use crate::secure::{SecureHandshakeHeader, crypto::{CryptoStore, EncryptType, KeyEncryptType}};

use super::SecureHandshakeError;

pub fn to_handshake_packet(crypto: &CryptoStore, key: &RsaPublicKey) -> Result<Vec<u8>, SecureHandshakeError> {
    ...
    Ok([header_data, encrypted_key].concat())
}
